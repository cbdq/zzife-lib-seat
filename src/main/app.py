...
if __name__ == '__main__':
    ...
    parser.add_argument('--time', type=str, default='06:00:02',
    ...
    parser.add_argument('--starttime', type=str, default='08:30', help='座位开始时间')
    parser.add_argument('--endtime', type=str, default='21:00', help='座位结束时间')
